...
public class Game extends Maps {
    ...
    public void gameInfo() {
        ...
        if (option == 1) {
            System.out.println("To play, type commands like 'Go left,' 'Dance Right,' or 'Enter Room.' ");
        ...
        if (option == 1) {
            System.out.println("Your main goal is to find your lost items and eventually escape the bar.");
            System.out.println("Type commands that make sense in the context to achieve your objectives.");
        }

        System.out.println("Type 'Play' to begin your adventure!");
        option2 = getInput.nextLine();

        if (option2.equalsIgnoreCase("play")) {
            System.out.println("Hey Bro! Good thing you finally woke up, check yourself dude.");
            ...
            if(option == 1){
                ...
                if(ProgressBar.size() == 4){
                    System.out.println("Congratulations you've found all your things!");
                }
            }
        }
    }
